...
<body id="page-top">
  ...
  <div id="wrapper" style="background: inherited;">
    ...
    <div id="content-wrapper" class="d-flex flex-column"style="background: inherited;">
      ...
      <div>
          <h4>Collection Stations</h4>
         <?php if($_SESSION['role'] == 'Admin') {?>

           <div class="text-right">
            <a href="./add-station.php" class="btn _btn-primary"><i class="fa fa-map-marker"></i>&nbsp;Add Station</a>
          </div>
  ...
  <?php } else  {?>
     <script src="assets/js/FarmerStations.js"></script>
