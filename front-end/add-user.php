    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <fieldset>  
            ...
            <div class="form-group" id="_stations" style="display: none;">
                
                <div>
                    <label>Assign Station</label>
                <select id="station"  name="station" class="myinput">
                   
                </select>
                    <p id="stationhelp" class="text-danger"></p>
                </div>
            </div> 
            ...
            <input type="submit" id="registerbtn"  name="register" value="Register User" class="authbtn">
        </form>
                  </div>
